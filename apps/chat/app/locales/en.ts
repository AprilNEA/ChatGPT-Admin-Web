...
const en: LocaleType = {
  ...
  Error: {
    ...
    ConfigurationError:
      "There is an error in the configuration of this function, please contact the administrator.",
    Unauthorized:
  ...
  User: {
    ...
    PleaseInput: (item: string) => `Please enter${item}`,
